...
const FEATURES_WITH_TRANSLATIONS = {
  "en-US": {
    ...
    appManagement: "Project management",
    cloudStrategy: "Business strategy",
    eCommerce: "Digital commerce",
    machineLearning: "Machine learning",
    marketing: "Optimization",
    qualityEngineering: "Quality engineering",
    softwareEngineering: "Supply chain",
    systemsDesign: "Systems design",
    webHosting: "Risk management",
    webManagement: "Process improvement",
    uiUxDesign: "Operational efficiency",
  },
  "hu-HU": {
